  ...
  return (
    <div className="h-screen bg-white flex items-center justify-center">
      <div className="max-w-md mx-auto text-center px-4">
        ...
        <h1 className="font-heading font-black text-2xl text-gray-900 mb-4">Chat Error</h1>
        <p className="font-sans text-gray-600 mb-8 leading-relaxed">
          We couldn't load the chat interface. This might be a temporary issue with the AI service.
        </p>
